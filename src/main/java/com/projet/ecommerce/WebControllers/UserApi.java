...
import com.projet.ecommerce.Services.ServicesImp.AccountServiceImp;
...
public class UserApi {
    ...
    public Map<String,String> login(String username, String password){
        ...
        Instant instant=Instant.now();
         //String customer = authentication.getCredentials().toString();
    ...
    public ResponseEntity<AppUser> Sign(@RequestBody AppUser appUser){
        return new ResponseEntity<>(accountService.addAppUser(appUser), HttpStatus.OK);
    }
